...
Balash **directs and measures; it does not coerce.** A review here is not a gate, a verdict, or a
...
review never forces compliance. (Balash could not enforce anyway — it steers a model with prose, not
...
**standalone** on any diff/branch/PR that Balash did not build. It exists because a plain "is this good?"
